...
trainX = trainX.astype("float32") / 255.0   # 归一化
...
trainX1k_x = np.array(trainX1k_x)           #转换为numpy类型
trainX1k_y = np.array(trainX1k_y)
...
#训练
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir="./logs/小数据模型")
